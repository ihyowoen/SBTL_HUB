...
function validateScoutJson(parsed) {
  ...
  // summary: prompt 80~150자 → validator 40~200자
...
function validateAnalystJson(parsed, stage1Facts = []) {
  ...
  // interpretation: prompt 100~200자 → validator 60~300자
  ...
  // key_tension: prompt 15~40자 → validator 8~60자
...
function validateRedTeamJson(parsed, stage1Facts = []) {
  ...
  // counter_scenario: prompt 80~180자 → validator 50~260자
  // fact id 참조 최소 1개 포함
  ...
  // next_checkpoints: 정확히 2개, 각 15~70자
