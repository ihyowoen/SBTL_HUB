...
artifact={
 'stage':'0.7','status':'PASS' if len(passed)==7 and not holds else 'HOLD',
 'run_tag':'20260903_R6_PROMPT_0_7_POLISHED7_R1',
 ...
 'current_run_id_file':str(IDS.relative_to(ROOT)),'current_run_id_count':7,
 ...
 'accounting':{'input':7,'publish_ready':len(passed),'held_or_returned':len(holds),'accounted':len(passed)+len(holds)},
