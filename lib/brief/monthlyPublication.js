...
function validateQc(errors, qc, path) {
  ...
  if (qc.notes != null && typeof qc.notes !== "string") push(errors, `${path}.notes`, "must be a string when present");
}
...
export function validateMonthlyBriefItem(item, path = "item") {
  ...
  if (!approval || typeof approval !== "object" || Array.isArray(approval)) {
    ...
    if (approval.notes != null && typeof approval.notes !== "string") push(errors, `${path}.approval.notes`, "must be a string when present");
