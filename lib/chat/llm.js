// ============================================================================
// LLM helper — Gemini Flash-Lite (primary) + Groq (auto fallback)
// ============================================================================
// Provider strategy:
//   1. GEMINI_API_KEY 있으면 → Gemini 2.5 Flash-Lite 시도
//   2. Gemini가 5xx/rate-limit/timeout → Groq 자동 재시도 (GROQ_API_KEY 있으면)
//   3. GEMINI 없고 GROQ만 → 바로 Groq
//   4. 둘 다 없음 → null ("no-api-key")
//
// 왜 Flash-Lite:
//   - Flash는 무료 tier 인기로 peak time 503 자주 발생
//   - Flash-Lite는 RPM 15 / RPD 1000 (Flash 대비 1.5-4배 여유), 과부하 덜함
//   - 품질 차이: opener JSON 생성/followup 한국어엔 충분
// ============================================================================
