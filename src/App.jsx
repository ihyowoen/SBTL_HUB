...
const REGION_POLICY = {
  NA: {
    ...
    policies: [
      ...
      { name: "관세 / Section 301", desc: "중국산 배터리·소재·BOS 부품에 대한 관세와 우회 수출 리스크가 미국 시장 접근성을 좌우합니다." },
      { name: "제조 인센티브", desc: "45X 첨단제조 크레딧은 미국 내 셀·모듈·광물 가공 투자의 핵심 유인입니다." },
      { name: "ESS / 전력", desc: "standalone ESS 세액공제와 분산자원 시장참여 확대가 수요를 견인합니다." },
    ],
    why: "미국은 보조금과 규제가 동시에 작동합니다. FEOC 준수 여부가 시장 접근 자체를 결정합니다.",
    watchpoints: ["FEOC 세부 해석 업데이트", "Section 301 관세 연장·조정", "45X/MACR 적용 기준 변화"],
  },
  EU: {
    flag: "🇪🇺",
    title: "유럽 정책",
    policies: [
      { name: "Battery Regulation", desc: "배터리 여권, 탄소발자국, 재활용률 의무가 단계적으로 강화됩니다." },
      { name: "CBAM", desc: "탄소국경조정은 소재·부품 단가와 공급망 선택에 영향을 줄 수 있습니다." },
    ...
    watchpoints: ["Battery Passport 파일럿", "CBAM 본격 부과", "CRM Act 세부 이행"],
  },
  CN: {
    flag: "🇨🇳",
    title: "중국 정책",
    policies: [
      { name: "산업정책", desc: "대형 배터리 기업 중심의 규모·가격 경쟁력이 이어지고 있습니다." },
    ...
    watchpoints: ["흑연 수출허가 운용", "LFP 과잉설비 조정", "제3국 우회 수출"],
  },
  KR: {
    flag: "🇰🇷",
    title: "한국 정책",
    policies: [
      ...
      { name: "규제 대응", desc: "EU Battery Regulation, 미국 FEOC 대응을 위한 추적성·원산지 관리가 핵심입니다." },
    ],
    why: "한국은 K-배터리 본거지입니다. 수출 규제 대응과 내수 ESS 시장 형성이 동시에 중요합니다.",
    watchpoints: ["ESS 안전기준 개정", "용량시장/조달 결과", "배터리 여권 국내 적용"],
  },
  JP: {
    flag: "🇯🇵",
    title: "일본 정책",
    ...
    watchpoints: ["METI 보조금 공모", "GX 집행 진도", "계통용 ESS 규칙"],
  },
  GL: {
    flag: "🌐",
    title: "글로벌 공통",
    policies: [
      ...
      { name: "광물 확보", desc: "리튬·니켈·코발트·흑연 확보전과 자원국 규제가 확대되고 있습니다." },
    ],
    why: "글로벌 밸류체인 재편은 모든 권역 정책의 배경입니다.",
    watchpoints: ["자원국 수출 정책", "광물 가격 변동", "제3국 가공 허브 확대"],
  },
};
...
function NewsDesk({ kb, onSubmitConsultation, consultSummaries = {}, dark }) {
  ...
  const regions = ["all", "top", "high", "KR", "US", "NA", "CN", "EU", "JP", "GL"];
