...
- **도구 상한 실측(2026-09-09): 한 세션의 WebSearch 는 200회에서 강제 차단된다.** 요구량 379~381 의 약 53% 다. 예산 확대는 상한(`CLAUDE_CODE_MAX_WEB_SEARCHES_PER_SESSION`) 조정 또는 세션 분할이지 오케스트레이터 재량이 아니다. 이날 200회로 셀 전수 90 + 표적 110 을 돌려 당일 명중 153/188 이었다.
