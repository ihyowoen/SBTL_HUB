...
// 최근 N일 내 워치 매칭 카드 수 — brief_now의 재료 게이팅용. 클라이언트 생성 조건
// (cardMatchesWatch + cardDateWithinDays, 매칭≥2)과 같은 기준으로 세어, 재료가 없는데
// "만들게"라고 거짓 약속하는 것을 방지한다. 날짜는 KST 기준 문자열 비교(카드 d=YYYY-MM-DD).
